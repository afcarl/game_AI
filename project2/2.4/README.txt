...
On the other hand to train a system from scratch you would have to run the train_ai.py script. It will start the procedure of learning from scratch and will get the parameters of the system in the fixed_variables.py file. When you kill the process (ctrl-c) the system will have the current learned table in the trained directory, from where it can be read and tested again.
