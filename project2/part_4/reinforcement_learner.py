...
class AI():
    ...
    def follow_ball(self):
        ...
        It works but fails sooon after u start increasing the speed of the ball.
        '''
...
#        paddle_vel = max(-2.0*self.FV.paddle_speed, min(paddle_vel, 2.0*self.FV.paddle_speed))
    ...
    def get_reward(self):
        ...
        If the game is over (death) then it returns a reward of -100.
        Otherwise: +1 (for not dying) - 10.0*distance_from_ball (This encourages it to 
...
class State_Convertor:
    ...
    def get_state(self, model):
        ...
        Returns the CURRENT STATE of the system. It separaetly calls two other
    ...
    def get_paddle_state(self, model):
        ...
        This function returns the x_cell num in the discretized world and returns 
    ...
    def get_ball_state(self, model):
        ...
        (num_ball_directions * num_ball_x * num_ball_y) (eg: between 0 - 4*32*4)
