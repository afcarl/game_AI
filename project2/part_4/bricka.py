...
##            print "Paddle.left = ", self.paddle.left
    ...
    def run_training(self):  
        '''
        This function does the actualy learning. It runs the learning episodes for ever
        until the program is cancelled. At which point it stores the Q table
...
#            self.draw_objects()
            ...
            if self.state == self.FV.STATE_GAME_OVER:
                ...
                if self.num_total_deaths%100 == 0:
                    ...
                    self.ai.decrease_EPSILON(0.005) #Decrement episolon paramter so it will explore less
